    ...
    <div className="min-h-screen bg-offwhite flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <Link href="/" className="flex items-center justify-center gap-2 mb-8">
          <motion.div
            className="w-10 h-10 rounded-md bg-brand-gradient flex items-center justify-center"
        ...
        <GlassCard className="p-8" blur="lg">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-small">
              <span className="bg-white/80 backdrop-blur-sm px-4 text-body">or sign up with email</span>
            </div>
          </div>
          ...
          <motion.p
            className="text-tiny text-body mt-4 text-center"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
